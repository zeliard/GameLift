...
#else
public:
    explicit AttributeValue(AttrType attrType) : m_attrType(attrType), m_SLCount(0), m_SDMCount(0)
    {
    }

    AttributeValue() : m_attrType(AttrType::NONE), m_SLCount(0), m_SDMCount(0)
    {
    }
    ...
    * <p>Construct an attribute value of type double.</p>
    */
    explicit AttributeValue(double n) : m_N(n), m_attrType(AttrType::DOUBLE), m_SLCount(0), m_SDMCount(0)
    {
    }
