...
namespace Server
{
    ...
    */
    ...
    Should be called when the server has finished any , before any GameLift-dependent initialization happens. The onStartGameSession callback
    will be invoked when the server is bound to a GameSession. Game-property-dependent initialization (such as loading a
